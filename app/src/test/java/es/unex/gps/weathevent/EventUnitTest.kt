...
class EventUnitTest {
    ...
    private val fecha = Fecha(25,12,2023,10, 30)

    @Test
    fun testEvent() {
        // Crear una instancia de un Event
        val evento = Event(
            1L,
            "Evento de prueba",
            "Cáceres",
        ...
        assertEquals("Evento de prueba", evento.name)
        assertEquals("Cáceres", evento.location)
        assertEquals(fecha, evento.date)
